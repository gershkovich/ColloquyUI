...
x = d3.scaleUtc().range([0, width]),
    ...
    z = d3.scaleLinear().range([height, height / 2]);


function buildChronologyChart(divId, dataIn, zMax, documentType) {
    ...
    z.domain([1, Math.log10(1000)]);  //always 24 hours
...
//create brush function redraw scatterplot with selection
    ...
    function render(tension) {
        ...
        var line = d3.line()
            ...
            .x(function (d) {
                return x(parseDate(d.x)) + margin.left;
            })
            .y(function (d) {
                return y_event(d.y);
            });
