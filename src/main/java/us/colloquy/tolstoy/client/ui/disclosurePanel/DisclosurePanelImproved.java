package us.colloquy.tolstoy.client.ui.disclosurePanel;
...
public class DisclosurePanelImproved extends Composite implements
													   //													   FiresDisclosureEvents,
		HasWidgets.ForIsWidget,
        HasAnimation,
        HasOpenHandlers<DisclosurePanelImproved>,
        HasCloseHandlers<DisclosurePanelImproved>
{
	...
	private final class ClickableHeader extends SimplePanel
	{
		...
		private ClickableHeader()
		{
			...
			elem.getStyle().setProperty( "wordwrap", "normal" );
		}
	...
	private static class ContentAnimation extends Animation
	{
		...
		/**
		 * The {@link DisclosurePanelImproved} being affected.
		 */
		private DisclosurePanelImproved curPanel;
		 ...
		 */
		public void setOpen( DisclosurePanelImproved panel, boolean animate )
		{
	...
	/**
	 * The default header widget used within a {@link DisclosurePanelImproved}.
	 */
	private class DefaultHeader extends Widget implements HasText,
            OpenHandler<DisclosurePanelImproved>,
            CloseHandler<DisclosurePanelImproved>
	{
		...
		private DefaultHeader( Imager imager, String text )
		{
			...
			labelTD.setPropertyString( "wordwrap", "normal" );
			labelTD.setPropertyString( "whitespace", "normal" );
		...
		public final void onClose( CloseEvent<DisclosurePanelImproved> event )
		{
			setStyle();
		}

		public final void onOpen( OpenEvent<DisclosurePanelImproved> event )
		{
			setStyle();
		}
	...
	/**
	 * Creates an empty DisclosurePanelImproved that is initially closed.
	 */
	public DisclosurePanelImproved()
	{
...
//	 * @deprecated use
//	 * {@link #DisclosurePanelImproved(ImageResource, ImageResource, String)}
...
//	}
	...
	/**
	 * Creates a DisclosurePanelImproved with the specified header text, an initial
	 * open/close state and a bundle of images to be used in the default header
	 * widget.
	 *
	 ...
	 * @param headerText  the text to be displayed in the header
	 */
	public DisclosurePanelImproved(ImageResource openImage, ImageResource closedImage,
                                   String headerText )
	{
		this();
	...
	/**
	 * Creates a DisclosurePanelImproved that will be initially closed using the specified
	 * text in the header.
	 *
	 * @param headerText the text to be displayed in the header
	 */
	public DisclosurePanelImproved( String headerText )
	{
...
//	}
	...
	public HandlerRegistration addCloseHandler(
			CloseHandler<DisclosurePanelImproved> handler )
	{
...
//	}
	...
	public HandlerRegistration addOpenHandler(OpenHandler<DisclosurePanelImproved> handler )
	{
...
//	}
	...
	/**
	 * Changes the visible state of this <code>DisclosurePanelImproved</code>.
	 *
